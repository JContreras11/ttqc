 ...
 $(function() {
  ...
  $(document).ready(function () {
    ...
    comboselect(ide_cat,base_url+'Home/get_cat','Seleccione la Categoria','item.ide_cat','item.cat_des','form-'+des,'cat');
