		...
		if(g_options.tile_enable_icons){
			...
			if(objItem.link && g_options.tile_show_link_icon == true || g_options.tile_as_link == true){
				...
				if(g_options.tile_as_link == false){
					...
					htmlAdd += "<a href='"+objItem.link+"'"+linkTarget+" class='ug-tile-icon ug-icon-link del-item' onclick='delete_image(e)'></a>";
				}else{
					htmlAdd += "<div class='ug-tile-icon ug-icon-link del-item' style='display:none' onclick='delete_image(e)'></div>";
				}
